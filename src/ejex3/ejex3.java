...
import ejex3.Servicies.Servicies;

public class ejex3 {

    public static void main(String[] args) {
        Servicies op1 = new Servicies();
        op1.llenarObjeto();
        System.out.println(op1.getDiscriminante());
        System.out.println(op1.tieneRaices());
        System.out.println(op1.tieneRaiz());
        op1.obtenerRaices();
        op1.obtenerRaiz();
        op1.calcular();
    }
